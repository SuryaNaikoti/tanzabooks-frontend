  ...
  return (
    <View style={[styles.container, styles.shadowProp, { borderRadius: 0 }]}>
      <View style={styles.box}>
          ...
          <View style={styles.social_logo}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                Linking.openURL("https://www.instagram.com/tanzabookss/");
              }}
            >
              <Image
        ...
        <View style={styles.social_logoWeb}>
          <TouchableOpacity
            style={styles.shadowProp}
            onPress={() => {
              Linking.openURL("https://www.facebook.com/Tanzabooks");
      ...
      <View style={styles.company_add}>
        ...
        <View style={styles.company_addcontent}>
          <Text style={styles.company_add_text}>
            ...
            <TouchableOpacity
              onPress={() => {
                Linking.openURL("http://truequations.com/");
              }}
            >
              <Text style={{ color: colors.primary }}> TruEquations</Text>
            </TouchableOpacity>{" "}
          </Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  logo: {
    ...
    marginLeft: wp(100) < 425 ? -40 : "",
    height: 50,
    resizeMode: "contain",
    alignSelf: wp(100) < 425 ? "center" : "flex-start",
  },
  text_box: {
    width: "70%",
    alignSelf: wp(100) < 425 ? "center" : "flex-start",
  ...
  social_logoWeb: {
    ...
    justifyContent: "space-between",
    alignContent: "center",
    alignSelf: wp(100) < 425 ? "center" : "center",
